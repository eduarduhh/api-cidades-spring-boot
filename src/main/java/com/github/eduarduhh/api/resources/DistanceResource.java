...
import com.github.eduarduhh.api.service.DistanceService;
import com.github.eduarduhh.api.service.EarthRadius;
...
public class DistanceResource {
	...
	/*
	 * @GetMapping("/by-math") public Double byMath(@RequestParam(name = "from")
	 * final Long city1,
	 * 
	 * @RequestParam(name = "to") final Long city2,
	 * 
	 * @RequestParam final EarthRadius unit) { log.info("byMath"); return
